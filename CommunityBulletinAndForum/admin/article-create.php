...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO posts (title, content, post_type, category, author_id) VALUES (?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssi", $title, $content, $post_type, $category, $admin_id);
...
<html lang="en">
    <head>
        ...
        <title>Create Post - Community Bulletin Admin</title>
    ...
    <div class="content flex-center">
        <div class="popup w-full">
          <form class="form" method="post">
            ...
            <button class="submit" style="width: 100%">Add Post</button>
          </form>
        </div>
    </div>
</body>
