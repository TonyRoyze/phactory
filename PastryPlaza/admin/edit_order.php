...
if (isset($_POST['order'])) {
    ...
    $sql = "UPDATE orders SET user_id = '$user_id', total_price = '$total', address = '$address', is_shipped = '$status' WHERE order_id = '$order_id'";
...
<form method="POST" class="checkout-container">
  <div class="card address">
    ...
    <div class="address-input-container">
      ...
      <select name="status" class="input_field">
        <option value="0" <?php if ($status == 0) echo 'selected'; ?>>Pending</option>
        <option value="1" <?php if ($status == 1) echo 'selected'; ?>>Shipped</option>
      </select>
    </div>
  </div>
