...
<body>
    ...
    <nav class="top-nav">
        <div class="nav-container">
            <a href="app.php" class="nav-brand">
                <img src="logo.svg" alt="The Rainbow Forum" class="logo">
            </a>
            <ul class="nav-links">
                <li><a href="app.php?view=posts" class="<?= ($view === 'posts' || $view === 'post') && !isset($_GET['category']) ? 'active' : '' ?>">All Categories</a></li>                
                <?php foreach ($all_categories as $category): ?>
                    <li><a href="app.php?view=posts&category=<?= urlencode($category) ?>" class="<?= (isset($_GET['category']) && $_GET['category'] === $category) ? 'active' : '' ?>"><?= htmlspecialchars($category) ?></a></li>
                <?php endforeach; ?>
